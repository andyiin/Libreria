...
export default function VistaDetallada(props: {
    id: string;
    libro: WithId<LibroModel>;
    librosAutor: WithId<LibroModel>[];
}) {
    return (
        <div className="bg-zinc-300 text-black py-10 px-20">
            <div className="flex">
            ...
            <div className="flex justify-center">
                <h2 className="text-xl"><b>Otros libros del autor</b></h2>
            </div>
            <div>
                {props.librosAutor && (
